...
function initControls() {
  ...
  $("#btnLG").on("click", function (e) {
    ...
    Limg =
      ...
      nom_couche_WMS +
      "&LEGEND_OPTIONS=fontColor:0x505050;fontAntiAliasing:true";
    var hauteur = HauteurCarte() - 150;
    var LegendWindow = window.open(
      "",
      "_blank",
      "width=500,height=" + hauteur + ",menubar=0,status=0,titlebar=0,toolbar=0"
    );
    LegendWindow.document.write(
      "<html><head><title>" +
        FS.main.langage[26][FS.main.langue] +
        "</title></head><span style='font-family:arial;color:" +
        FS.main.background_color +
        ";font-size:160%;'>" +
        FS.main.langage[26][FS.main.langue] +
        "</span><p style='font-family:arial;color:#505050;'>" +
        titre_couche_WMS +
        "</p><img src=" +
        Limg +
        ">"
